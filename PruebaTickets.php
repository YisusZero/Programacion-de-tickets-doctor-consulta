...
function fechaCastellano ($fecha) {
  ...
  $Producto=$_POST["SaldoActualTicket"];
  $CantidadProd=$_POST["SaldoActualTicket"];
  $TotalProd=$_POST["SaldoActualTicket"];
...
$printer -> feed(1);
$printer->text("Calle 57 por 40 y 42" . "\n");
$printer->text("Tekax,Yucatán " . "\n");
$printer->text("CP: 97970" . "\n");

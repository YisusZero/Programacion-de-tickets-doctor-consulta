...
function fechaCastellano ($fecha) {
 ...
 foreach ($_POST["TotalVentas"] as $TotalEfectivo) {
  ...
  foreach ($_POST["cliente"] as $Ncliente) {
    ${"clientela".$i} = $Ncliente;
     $i++;
  }
...
if($Formadepago == "Crédito Enfermería"){
  $printer -> text("Credito de enfermería  \n");
  $printer -> text("$ValorEfectivo   \n");
} 
if($Formadepago == "Crédito Médico"){
  $printer -> text("Credito de médico  \n");
  $printer -> text("$ValorEfectivo  \n ");
} 
if($Formadepago == "Crédito Médico Especialista"){
  $printer -> text("Crédito de médico especialista  \n");
  $printer -> text("$ValorEfectivo \n");
} 
$printer -> text("Cliente:  \n");
$printer -> text("$Ncliente \n");
